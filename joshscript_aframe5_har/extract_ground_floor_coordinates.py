#!/usr/bin/env python3
"""
Extract Ground Floor coordinates from HAR file and create browser extraction script
"""
...
def main():
    print("=== GROUND FLOOR COORDINATE EXTRACTION ===")
    
    # The actual Ground Floor project URL from the HAR file
    ground_floor_url = "https://projects.asbuiltvault.com/asset/26cea261-340c-440e-ab72-793c42eb6f1f/plan-viewer/2773c270-1382-4c53-8aa1-8dd25b15a460/"
    
    print(f"Ground Floor URL: {ground_floor_url}")
    print()
    
    # Create the browser extraction script
    extraction_script = f"""
// GROUND FLOOR COORDINATE EXTRACTION SCRIPT
// Run this in the browser console on: {ground_floor_url}
...
"""
    ...
    with open('ground_floor_extraction_script.js', 'w', encoding='utf-8') as f:
...
<body>
    ...
    <div class="url">
        ...
        <a href="{ground_floor_url}" target="_blank">{ground_floor_url}</a>
    </div>
    ...
    <div class="code" id="script">{extraction_script}</div>
...
"""
    ...
    with open('ground_floor_extraction_helper.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("Files created:")
    print("  - ground_floor_extraction_script.js")
    print("  - ground_floor_extraction_helper.html")
    print()
    print("Open ground_floor_extraction_helper.html in your browser")
    print("   Follow the instructions to extract the coordinates")
