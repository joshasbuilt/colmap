#!/usr/bin/env python3
"""
Extract First Floor coordinates from HAR file and create browser extraction script
"""
...
def main():
    print("=== FIRST FLOOR COORDINATE EXTRACTION ===")
    
    # The actual First Floor project URL from the HAR file
    first_floor_url = "https://projects.asbuiltvault.com/asset/26cea261-340c-440e-ab72-793c42eb6f1f/plan-viewer/3427e14c-ab69-46d2-94bb-115cc3811995/"
    
    print(f"First Floor URL: {first_floor_url}")
    print()
    
    # Create the browser extraction script
    extraction_script = f"""
// FIRST FLOOR COORDINATE EXTRACTION SCRIPT
// Run this in the browser console on: {first_floor_url}
...
"""
    ...
    with open('first_floor_extraction_script.js', 'w', encoding='utf-8') as f:
...
<body>
    ...
    <div class="url">
        ...
        <a href="{first_floor_url}" target="_blank">{first_floor_url}</a>
    </div>
...
"""
    ...
    with open('first_floor_extraction_helper.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    
    print("Files created:")
    print("  - first_floor_extraction_script.js")
    print("  - first_floor_extraction_helper.html")
    print()
    print("Open first_floor_extraction_helper.html in your browser")
    print("   Follow the instructions to extract the First Floor coordinates")
