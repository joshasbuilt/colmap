#!/usr/bin/env python3
"""
Run panorama reconstruction for Camera02 video with loop detection enabled
"""
...
examples_dir = repo_root / "paul" / "python" / "examples"
...
def main():
    ...
    mask_template = base_dir / "mask_template.png"
    output_dir = base_dir / "reconstruction_panorama"
    ...
    parser = argparse.ArgumentParser(description="Run panorama_sfm on Camera02 video frames")
    ...
    print("\n" + "="*80)
    print("Panorama reconstruction complete!")
    print(f"Output directory: {output_dir}")
    print("="*80)
